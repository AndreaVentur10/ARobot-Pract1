            ...
            if blobs == 1:
                ...
                if W != 'OK':
                    ...
                    if WL != 'OK':  # si hay choque lateral
                        if WL == 'D':
                            lspeed, rspeed = vel_base + Px + Pdepth - PsepL, vel_base + Px + Pdepth + PsepL
                        elif WL == 'I':
                            lspeed, rspeed = vel_base - Px + Pdepth + PsepL, vel_base + Px + Pdepth - PsepL
                ...
                if W != 'OK':
                    ...
                    if W == 'CD':
                        lspeed, rspeed = vel_base + PsepF, vel_base - PsepF  #+ Px + Pdepth
                        print('01')
                    elif W == 'CI':
                        lspeed, rspeed = vel_base - PsepF, vel_base + PsepF  #- Px + Pdepth
                        print('09')
                    ...
                    if WL != 'OK':  # si hay choque lateral
                        if WL == 'D':
                            lspeed, rspeed = vel_base - PsepL, vel_base + PsepL
                        elif WL == 'I':
                            lspeed, rspeed = vel_base + PsepL, vel_base - PsepL
                        print('CHOQUE LATERAL')
